...
class ASMPermissionController extends BaseController
{
    ...
    {
        if ($request->ajax() && permission('asm-permission-add')) {
            $permission_data = [];
    ...
    {
        if ($request->ajax() && permission('asm-permission-edit')) {
    ...
    {
        if ($request->ajax() && permission('asm-permission-delete')) {
    ...
    {
        if ($request->ajax() && permission('asm-permission-bulk-delete')) {
