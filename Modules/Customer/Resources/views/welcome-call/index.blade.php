                ...
                <div class="card-header flex-wrap py-5">
                    <form method="POST" id="form-filter" class="col-md-12 px-0">
                        <div class="row">
                            ...
                            <x-form.selectbox labelName="Status" name="call_status" col="col-md-3" class="selectpicker">
                                @foreach(WELCOME_CALL_STATUS as $key => $value)
        ...
        $(document).ready(function () {
            table = $('#dataTable').DataTable({
                ...
                "buttons": [
                    ...
                    {
                        'className': 'btn btn-info btn-sm d-none text-white bulk_approve_btn',
                        'text': '<i class="far fa-check-circle"></i> Bulk Approve',
                        action: function () {
                            bulkApprove();
                        }
                    },
            ...
            setupTableReloadOnChange('#form-filter #call_status');
            ...
            $(document).on('click', '#approve_call', function () {
                let id = $(this).data('id');
                let url = "{{ route('welcome.call.change.status') }}";

                Swal.fire({
                    title: 'Are you sure?',
                    text: "You want to approve this call?",
                    icon: 'warning',
