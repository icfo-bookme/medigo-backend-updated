...
<div class="form-group col-md-12">
    ...
    <table class="table table-borderless customer">
        <tr>
            <td width="{{ permission('customer-add') ? '80%' : '100%' }}">
                <select class="form-control selectpicker" name="customer_id" id="customer_id" data-live-search="true"></select>
            </td>
            <td width="20%" class="text-right"><button type="button" class="btn btn-sm btn-primary" onclick="showFormModal('Add New Customer','Save')"> <i class="fas fa-plus-square"></i> </button></td>
        </tr>
    </table>
