...
@section('content')
                ...
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        ...
                        @if (permission('bank-add'))
                            <a href="javascript:void(0);" onclick="showFormModal('Add New Order With Call','Save')"
    ...
    @include('sale::order-with-call.modal')
@endsection
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#dataTable').DataTable({
                ...
                "ajax": {
                    "url": "{{ route('order-with-call.datatable.data') }}",
                    "type": "POST",
                    "data": function(data) {
            ...
            $(document).on('click', '#save-btn', function() {
                ...
                let url = "{{ route('order-with-call.store.or.update') }}";
            ...
            $(document).on('click', '.edit_data', function() {
                ...
                if (id) {
                    $.ajax({
                        url: "{{ route('order-with-call.edit') }}",
                        type: "POST",
                        data: {
                            id: id,
                            _token: _token
                        ...
                        //         $('#store_or_update_form #link_address').val(data.link_address);
                        //         $('#store_or_update_form #user_address').val(data.user_address);
                        ...
                        success: function(data) {
                            ...
                            $('#store_or_update_modal .modal-title').html(
                                '<i class="fas fa-edit text-white"></i> Edit Order'
                            );
            ...
            $(document).on('click', '.delete_data', function() {
                ...
                let name = $(this).data('name');
                let row = table.row($(this).parent('tr'));
                let url = "{{ route('order-with-call.delete') }}";
