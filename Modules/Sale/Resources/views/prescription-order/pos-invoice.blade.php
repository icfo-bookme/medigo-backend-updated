                            ...
                            <div class="invoice overflow-auto">
                                <div>
                                    ...
                                    <table>
                                        <tr>
                                            <td width="50%">
                                                <div class="invoice-to">
                                                    ...
                                                    @if($sale->order_type == 1)
                                                        ...
                                                        <div class="address"><b>Address : </b><span>{{ $sale->information}}</span>  <span> <br>{{ $sale->optional_information}}</span></div>
                                                    @else
                                                        <div class="phone"><b>Phone : </b><span>{{ $sale->customer ? $sale->customer->mobile : ''}}</span></div>
                                                        <div class="address"><b>Address : </b><span>{{ $sale->customer ? $sale->customer->information : ''}}</span>  <span> <br>{{ $sale->customer ? $sale->customer->optional_information : ''}}</span></div>
                                                    @endif
                                                </div>
                                            </td>
                                            <td width="50%" class="text-right">
                                                ...
                                                <div class="m-0 date"><b>Status:</b><button type="button" class="btn btn-primary">{{VOUCHER_STATUS[$sale->delivery_status]}}</button></div>
                                            </td>
                                        </tr>
                                    </table>
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            <td colspan="5" class="text-left"></td>
                                            <td colspan="2"  class="text-right">DISCOUNT @if($sale->order_discount_per == 2) % @else TK @endif</td>
                                            <td class="text-right">
                                                @if (config('settings.currency_position') == 2)
                                                    {{ number_format($sale->order_discount,2) }} @if($sale->order_discount_per == 1) {{ config('settings.currency_symbol') }} @endif
                                                @else
                                                    @if($sale->order_discount_per == 1) {{ config('settings.currency_symbol') }} @endif{{ number_format($sale->order_discount,2) }}
                                                @endif
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td colspan="5" class="text-left"></td>
                                            <td colspan="2"  class="text-right">ADJUSTMENT @if($sale->adjustment_per == 2) (-) @else (+) @endif</td>
                                            <td class="text-right">
                                                @if (config('settings.currency_position') == 2)
