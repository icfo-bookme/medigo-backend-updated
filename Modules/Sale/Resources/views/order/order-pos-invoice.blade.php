                                    ...
                                    <table>
                                        <tr>
                                            <td width="50%">
                                                <div class="invoice-to">
                                                    ...
                                                    <div class="phone"><b>Phone :
                                                        </b><span>{{ $sale->customer ? $sale->customer->phone : $sale->phone }}</span>
                                                    </div>
                                            ...
                                            <td width="50%" class="text-right">
                                                ...
                                                <div class="m-0 date"><b>Date:</b>
                                                    {{ date('Y-m-d h:i:s a', strtotime($sale->created_at)) }}
                                                    {{--                                                    {{ date('d-M-Y',strtotime($sale->sale_date)) }} --}}
                                                </div>
                                                <div class="m-0 date"><b>Status:</b>
                                                    <button type="button"
                                                        class="btn btn-primary">{{ VOUCHER_STATUS[$sale->delivery_status] }}</button>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                    <table border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                @foreach ($sale->products as $key => $item)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right total">
                                                            {{ number_format($item->pivot->total, 2) }}</td>
                                                    </tr>
                                                @endforeach
                                            @endif
                                        </tbody>
                                        <tfoot>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    @if (config('settings.currency_position') == 2)
                                                        {{ number_format($sale->order_tax, 2) }}
                                                        {{ config('settings.currency_symbol') }}
                                                    @else
                                                        {{ config('settings.currency_symbol') }}
                                                        {{ number_format($sale->order_tax, 2) }}
                                                ...
                                                <td class="text-right">
                                                    ...
                                                    @else
                                                        @if ($sale->order_discount_per == 1)
                                                            {{ config('settings.currency_symbol') }}
                                                        @endif
                                                        {{ number_format($sale->order_discount, 2) }}
                                                    @endif
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    @if (config('settings.currency_position') == 2)
                                                        {{ number_format($sale->adjustment, 2) }}
                                                        {{ config('settings.currency_symbol') }}
                                                    @else
                                                        {{ config('settings.currency_symbol') }}
                                                        {{ number_format($sale->adjustment, 2) }}
                                            ...
                                            <tr>
                                                <td colspan="5" class="text-left"></td>
                                                <td colspan="2" class="text-right">COUPON
                                                    ({{ $sale->coupon->name ?? '' }})</td>
                                                <td class="text-right">
                                            ...
                                            <td class="text-center">
                                                <div class="font-size-10" style="width:250px;float:right;">
                                                    <p style="margin:35px 0 0 0;padding:0;"><b class="text-uppercase">
                                                        ...
                                                        </b><br> {{ date('d-M-Y h:i:s A', strtotime($sale->created_at)) }}
                                                    </p>
                                                    <p class="dashed-border"></p>
