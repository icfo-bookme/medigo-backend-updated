...
@section('content')
    ...
    @include('setting::delivery-charge.modal')
@endsection
    ...
    <script>
        ...
        $(document).ready(function () {
            table = $('#dataTable').DataTable({
                ...
                "ajax": {
                    "url": "{{ route('delivery-charge.datatable.data') }}",
                    "type": "POST",
                    "data": function (data) {
            ...
            $(document).on('click', '#save-btn', function () {
                ...
                let url = "{{route('delivery-charge.store.or.update')}}";
            ...
            $(document).on('click', '.edit_data', function () {
                ...
                if (id) {
                    $.ajax({
                        url: "{{route('delivery-charge.edit')}}",
                        type: "POST",
            ...
            $(document).on('click', '.delete_data', function () {
                ...
                let url = "{{ route('delivery-charge.delete') }}";
            ...
            function multi_delete() {
                ...
                if (ids.length == 0) {
                    ...
                    let url = "{{route('delivery-charge.bulk.delete')}}";
            ...
            $(document).on('click', '.change_status', function () {
                ...
                let row = table.row($(this).parent('tr'));
                let url = "{{ route('delivery-charge.change.status') }}";
