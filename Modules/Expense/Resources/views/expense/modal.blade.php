          ...
          @csrf
            ...
            <div class="modal-body">
                <div class="row">
                  ...
                  @endif
                    <x-form.selectbox labelName="Expense Type" name="expense_item_id" col="col-md-6" required="required" class="selectpicker">
                    ...
                    <x-form.selectbox labelName="Payment Type" name="payment_type" required="required" onchange="account_list(this.value)"  col="col-md-6" class="selectpicker">
