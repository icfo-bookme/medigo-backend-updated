...
class Expense extends BaseModel
{
    ...
    *******************************************/
    ...
    protected $_expense_item_id, $_warehouse_id, $_sort_table;
    ...
    private function get_datatable_query()
    {
        ...
        if (permission('expense-bulk-delete')){
            ...
            {
                $this->column_order = ['id','id','date','expense_item_id','remarks','payment_type','account_id','amount',null];
            }else{
                $this->column_order = ['id','id','date','warehouse_id','expense_item_id','remarks','payment_type','account_id','amount',null];
            }
