                ...
                <div class="card card-custom">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <input type="hidden" name="update_id" value="{{$generic->id}}">
                                    <x-form.textbox labelName="Generic Name" name="generic_name" required="required" col="col-md-8" value="{{$generic->generic_name}}"/>
                                    <div class="col-md-4 text-center">
                                        <button type="button" class="btn btn-primary btn-sm mr-3 mt-8" onclick="storeData(1)" id="save-btn-1"><i class="far fa-save"></i> Update</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                    @foreach($generic_description as $key=>$row)
                                        <form method="post" action="{{route('generic.details.update')}}">
                                            @csrf
                                            <input type="hidden" class="form-control" name="id" value="{{$row->id}}"/>
                                            <input type="hidden" class="form-control" name="generic_id" value="{{$row->generic_id}}"/>
                                            <tr class="text-center" >
                                                <td style="width: 30%;">
                                                ...
                                                <td>
                                                    <button type="submit" class="btns btn-primary btn-sm mr-3"  id="save-btn-1"><i class="far fa-save"></i> Update </button>
                                                </td>
                                            </tr>
                                        </form>
                                    @endforeach
                                ...
                                <form method="post" action="{{route('generic.details.update')}}">
                                    @csrf
                                    <input type="hidden" class="form-control" name="generic_id" value="{{$generic->id}}"/>
                                    <table class="table table-bordered" id="unitTable">
                                        <tr>
                                            ...
                                            <td>
                                                <button type="submit" class="btns btn-primary btn-sm mr-3"  id="save-btn-1" style=" margin-left: 35%;"><i class="far fa-save"></i> Save </button>
                                            </td>
