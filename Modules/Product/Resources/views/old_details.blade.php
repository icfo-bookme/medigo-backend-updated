                        ...
                        <div class="card-header">
                            <div class="card-toolbar">
                                <ul class="nav nav-bold nav-pills">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link " data-toggle="tab" href="#variants">Product Details</a>
                                    </li>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description">
                                    <div class="table-responsive padding-top-10px">
                                        ...
                                        <table class="table table-bordered table-hover">
                                            <thead class="bg-primary">
                                            <th class="text-right">Generic Title</th>
                                            <th class="text-center">Generic Description</th>
                                            </thead>
                                            <tbody>
                                            <tr>
                                                <td  class="text-center"><b>{{$product->generic->generic_name}}</b></td>
                                            </tr>
                                            @php
                                                $g_details = \Modules\Product\Entities\GenericDetails::where('generic_id',$product->generic->id)->get();
                                            @endphp
                                            @foreach($g_details as $row)
                                                <tr>
                                                    <td class="text-right"><p style="text-align: center"><b>{{$row->title}}</b></p></td>
                                                    <td class="text-right"><p style="text-align: justify">{{$row->description}}</p></td>
                                                </tr>
                                            @endforeach
                                            </tbody>
                                        </table>
