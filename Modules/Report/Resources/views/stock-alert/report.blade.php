                ...
                <table style="margin-bottom:10px !important;">
                    <tr>
                        <td class="text-center">
                            ...
                            font-weight: bold;background: black;border-radius: 10px;width: 300px;color: white;text-align: center;padding:5px 0;}">STOCK ALERT REPORT</p>
                ...
                <table cellspacing="0" cellpadding="0" id="product_table">
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center font-weight-bolder">Brand</td>
                            ...
                            <td class="text-right font-weight-bolder">Alert Qty</td>
                        </tr>
                        @if (!$products->isEmpty())
                            @foreach ($products as $key => $value)
                                @php
                                    $warehouse_product = DB::table('warehouse_products')->where([
                                        'warehouse_id' => $warehouse_id,
                                        'product_id'   => $value->id,
                                    ])->first();
                                    $qty = $warehouse_product ? $warehouse_product->qty : 0;
                                @endphp
                                @if($warehouse_product && $qty <= $value->alert_quantity)
                                <tr>
                                    ...
                                    <td class="text-center"> {{ $value->unit->unit_name }} </td>
                                    <td class="text-center"> {{ $qty }} </td>
                                    <td class="text-right"> {{ $value->alert_quantity }} </td>
                                </tr>
                                @endif
                            @endforeach
                        @else
