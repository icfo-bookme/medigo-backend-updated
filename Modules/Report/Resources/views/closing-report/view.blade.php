                ...
                <div class="card-body">
                    ...
                    <div class="col-sm-12 table-responsive">
                        <div id="invoice">
                                            ...
                                            <td class="text-center">
                                                @if (config('settings.logo'))
                                                    <a href="{{ url('dashboard') }}">
                                                        <img
                                                            ...
                                                            style="max-width: 200px;margin-bottom:10px;" alt="Logo"/>
                                                    </a>
                                                @else
                                                ...
                                                @if(config('settings.contact_no'))
                                                    <p style="font-weight: normal;margin:0;"><b>Contact
                                                            No.: </b>{{ config('settings.contact_no') }} @if(config('settings.email'))
                            ...
                            font-weight: bold;background: black;border-radius: 10px;width: 320px;color: white;text-align: center;padding:5px 0;}">
                                                    Closing Account Details</p>
                                                <p style="font-weight: normal;margin:0;font-weight:bold;">
                                                    Date: {{ $details->date }}</p>
                                                <div class="text-center">
                                                    <div
                                                        style="font-weight: normal;margin:0;font-weight:bold;">{{ $details->title }}</div>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                    <table cellspacing="0" cellpadding="0" id="product_table">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center font-weight-bolder">Cash Platform</td>
                                            <td class="text-center font-weight-bolder">Amount</td>
                                        </tr>

                                        @foreach($details->dailyClosingHeads as $key => $value)
                                            <tr>
                                                <td class="text-center">{{ $key + 1 }}</td>
                                                <td class="text-center">{{ $value->closingHead->label_name }}</td>
                                                <td class="text-right">{{ $value->amount }}</td>
                                            </tr>
                                        @endforeach

                                        <tr>
                                            <td style="font-weight:bold;text-align: right !important;" colspan="2">
                                                Total
                                            </td>
                                            <td style="text-align: right !important;font-weight:bold;">{{ number_format($details->closing_amount,2,'.',',') }}</td>
                                        </tr>
                                        </tbody>
                                    </table>
                                    <br>
                                    <br>
                                    Note/Description : {{ $details->note }}
                                </div>
                            </div>
                        </div>
                    </div>
