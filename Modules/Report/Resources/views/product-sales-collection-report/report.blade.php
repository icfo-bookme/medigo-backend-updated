                ...
                <table style="margin-bottom:10px !important;">
                    <tr>
                        <td class="text-center">
                            ...
                            font-weight: bold;background: black;border-radius: 10px;width: 300px;color: white;text-align: center;padding:5px 0;}">PRODUCT SALES COLLECTION REPORT</p>
...
{{--                            <td class="text-center font-weight-bolder">Sl</td>--}}
                            <td class="text-center font-weight-bolder">Invoice No</td>
                            ...
                            <td class="text-right font-weight-bolder">Collection</td>
                        </tr>
                        @if (!$report_data->isEmpty())
                        @foreach ($report_data as $key => $value)
                        <tr>
                            <td class="text-center">{{$value->invoice_no}} </td>
                            <td class="text-left"> {!! $value->name !!} <br> <b>{{ $value->code }}</b></td>
                        ...
                        @endif
                        <tr>
                            <td style="font-weight:bold;text-align: right !important;" colspan="4">Total</td>
