                        ...
                        <div class="row">
                            ...
                            <div class="col-md-0">
                                <div style="margin-top:28px;">
                                    <button id="btn-filter" class="btn btn-primary btn-sm btn-elevate btn-icon" type="button" data-toggle="tooltip" data-theme="dark" title="Search"><i class="fas fa-search"></i></button>
                                    <button id="btn-reset" class="btn btn-danger btn-sm btn-elevate btn-icon ml-2" type="button" data-toggle="tooltip" data-theme="dark" title="Reset"><i class="fas fa-undo-alt"></i></button>
                                </div>
                            </div>
                        </div>
                    </form>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            table = $('#dataTable').DataTable({
                ...
                "ajax": {
                    "url": "{{route('deliveryman.report.datatable.data')}}",
                    "type": "POST",
                    "data": function (data) {
