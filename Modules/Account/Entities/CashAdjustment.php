    ...
    *******************************************/
    ...
    private function get_datatable_query()
    {
        ...
        if(auth()->user()->warehouse_id){
            $this->column_order = ['t.id', 't.voucher_no','t.voucher_date','t.description','t.debit','t.credit', 't.created_by',null];
        }else{
            $this->column_order = ['t.id', 't.warehouse_id','t.voucher_no','t.voucher_date','t.description','t.debit','t.credit', 't.created_by',null];
        }
    ...
    public function count_all()
    {
        ...
        return $query->where('voucher_type','ADJUSTMENT')->count();
    }
    /******************************************
