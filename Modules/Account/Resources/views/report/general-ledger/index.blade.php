            ...
            <div class="card-header flex-wrap py-5">
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row">
                        ...
                        <x-form.selectbox labelName="General Head" name="general_head" required="required"  col="col-md-3" class="selectpicker">
                        ...
                        <x-form.selectbox labelName="Transaction Head" name="transaction_head"  required="required" col="col-md-3" class="selectpicker"/>
                        ...
                        <div class="{{ (Auth::user()->warehouse_id) ? 'col-md-3' : 'col-md-12' }}">
