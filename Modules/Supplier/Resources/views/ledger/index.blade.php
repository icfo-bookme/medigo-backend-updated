    ...
    <script>
        $('.daterangepicker-filed').daterangepicker({
            callback: function (startDate, endDate, period) {
                ...
                $(this).val(title);
                $('input[name="from_date"]').val(start_date).trigger('change');
                $('input[name="to_date"]').val(end_date).trigger('change');
            }
        });

        var table, dateChangeTimeout;
        $(document).ready(function () {
            ...
            setupTableReloadOnChange('#form-filter #supplier_id');
