...
@section('content')
                ...
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        ...
                        @if (permission('coupon-add'))
                            <a href="javascript:void(0);" onclick="showFormModal('Add Customer Coupon','Save')" class="btn btn-primary btn-sm font-weight-bolder">
    ...
    @include('coupon::customer-coupon.modal')
@endsection
    ...
    <script>
        $(document).ready(function () {
            ...
            table = $('#dataTable').DataTable({
                ...
                "ajax": {
                    "url": "{{ route('customer.coupon.datatable.data') }}",
                    "type": "POST",
                    "data": function (data) {
                        data._token = _token;
                        data.check_customer = 1;
                    }
                },
                "columnDefs": [{
                    "targets": [0, 1, 4, 5],
            ...
            $(document).on('click', '#save-btn', function () {
                ...
                if (update_id) {
                    url = "{{ route('customer.coupon.update') }}";
                } else {
                    url = "{{ route('customer.coupon.store') }}";
                }
            ...
            $(document).on('click', '.edit_data', function () {
                ...
                if (id) {
                    $.ajax({
                        url: "{{ route('customer.coupon.edit') }}",
                        type: "POST",
                        ...
                        success: function (data) {
                            ...
                            $('#store_or_update_form #limit_count').val(data.customer_coupon[0].limit_count);
                            ...
                            data.customer_coupon.forEach(function (customer) {
                                selectedCustomers.push(customer.customer_id);
                            });
                            $('#store_or_update_form #customer_id').val(selectedCustomers);
                            $('#store_or_update_form #customer_id').trigger('change');
                            $('#store_or_update_form #customer_id').trigger('select2:render');
            ...
            $(document).on('click', '.change_status', function () {
                ...
                let url = "{{ route('customer.coupon.change.status') }}";
                Swal.fire({
