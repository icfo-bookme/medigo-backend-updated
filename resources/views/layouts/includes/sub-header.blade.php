    ...
    <div  class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center pt-4">
            ...
            <div class="filter-toggle btn-group float-right" style="margin-bottom: 1rem;margin-right: 1rem;">
                <div class="btn btn-primary btn-sm today-btn data-btn" data-start_date="{{ date('Y-m-d') }}" data-end_date="{{ date('Y-m-d') }}">Today</div>
                <div class="btn btn-primary btn-sm week-btn data-btn active" data-start_date="{{ date('Y-m-d',strtotime('-7 day')) }}" data-end_date="{{ date('Y-m-d') }}">This Week</div>
