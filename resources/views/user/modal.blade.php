          ...
          @csrf
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <x-form.selectbox labelName="Role" name="role_id" onchange="setShowroom(this.value)" required="required" col="col-md-6" class="selectpicker">
...
{{--                    <x-form.selectbox labelName="Showroom" name="warehouse_id" required="required" col="col-md-6 showroom d-none" class="selectpicker">--}}
