...
<div class="container-fluid m-0 p-0">
    <div class="row m-0 p-0">
        <div class="col-md-8 d-none d-lg-block d-xl-block" style="background-image: url({{ 'storage/'.LOGO_PATH.config('settings.logo')}});background-position: center;
                    ...
                    <div style="width: 80%;margin:0 auto;">
                        ...
                        <form class="form" action="{{ url('login') }}" method="POST">
                            ...
                            <div class="form-group py-3 m-0">
                                <input type="text" class="form-control placeholder-dark-75 @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}"
                            ...
                            <div class="form-group py-3">
                                <div class="input-group">
                                    <input type="password" class="form-control placeholder-dark-75 @error('password') is-invalid @enderror" name="password" id="password"
