                ...
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        @if (permission('brand-add'))
                            <a href="javascript:void(0);" onclick="showFormModal('Add New Company','Save')" class="btn btn-primary btn-sm font-weight-bolder"><i
            ...
            table = $('#dataTable').DataTable({
                ...
                "buttons": [
                    ...
                    },
                    {
                        ...
                        'columns': ':gt(0)',
                        "exportOptions": {
                            @if (permission('brand-bulk-delete') || permission('product-brand-bulk-delete'))
